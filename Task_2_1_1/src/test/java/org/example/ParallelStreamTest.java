...
/**
 * Класс тестов для проверки корректности реализации ParallelStream.
 */
class ParallelStreamTest {
    @Test
    void testParallelStreamChecker() throws ExecutionException, InterruptedException {
        PrimeCheckerBase checker = new ParallelStream();

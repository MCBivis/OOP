...
public class Hand {
  ...
  /**
   * Метод add() добавляет карту в руку и обновляет счет игрока. Если после добавления карты счет
   * превышает 21, проверяется наличие туза, и его значение может быть изменено с 11 на 1.
   *
  ...
  /**
   * Метод HandShow(int hidden) возвращает строковое представление карт в руке с одной скрытой
   * картой.
   *
  ...
  /**
   * Метод updateScore() обновляет счет, если значение превышает 21, и изменяет значение туза с 11
   * на 1.
   */
